...
const CategorySidebar: React.FC<SidebarProps> = ({ categories, activeId, onSelect, onAdd, onDelete, onRename }) => {
    ...
    <aside className="w-full md:w-64 flex flex-col bg-white border-r border-slate-200 shrink-0 h-48 md:h-full">
      ...
      <div className="p-4 border-t border-slate-100 mt-auto hidden md:block">
        <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
          <h4 className="text-xs font-bold text-slate-700 mb-1">Getting Started</h4>
          <p className="text-[10px] text-slate-500 leading-relaxed">
            Create categories to organize different parts of your workflow. Click the plus icon above to start.
          </p>
        </div>
      </div>
    </aside>
